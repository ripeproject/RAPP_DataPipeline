...
#ifdef USE_PCL
double nPlotUtils::computeDigitalBiomass(const cPlotPointCloud& plot, double voxel_size_mm)
{
...
#else
double nPlotUtils::computeDigitalBiomass(const cPlotPointCloud& plot, double voxel_size)
{
...
#ifdef USE_PCL
    double nPlotUtils::computeDigitalBiomass(const cPlotPointCloud& plot, int groundHeight_mm, double voxel_size_mm)
    {
        auto num_points_in_cloud = plot.size();
