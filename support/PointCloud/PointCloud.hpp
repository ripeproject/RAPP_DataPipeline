...
/**
 * Class to store a full point cloud generated by multiple frames of the sensor.
 */
...
class cGenericPointCloud : public cBasePointCloud<pointcloud::sCloudPoint_SensorInfo_t>
{
public:
	cGenericPointCloud() = default;
	explicit cGenericPointCloud(const cPointCloud& pc);
	explicit cGenericPointCloud(const cPointCloud_FrameId& pc);
	explicit cGenericPointCloud(const cPointCloud_SensorInfo& pc);

	cGenericPointCloud& operator=(const cPointCloud& pc);
	cGenericPointCloud& operator=(const cPointCloud_FrameId& pc);
	cGenericPointCloud& operator=(const cPointCloud_SensorInfo& pc);
	cGenericPointCloud& operator=(const cGenericPointCloud& pc) = default;
	...
	std::unique_ptr<cPointCloud>			createPointCloud();
	std::unique_ptr<cPointCloud_FrameId>	createPointCloud_FrameId();
	std::unique_ptr<cPointCloud_SensorInfo> createPointCloud_SensorInfo();
