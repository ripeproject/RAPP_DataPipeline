/**
 * @file
 * @brief Parser for reading HySpex VNIR 3000N image data from a block based data file
 */
#pragma once

#include <cbdf/HySpexVNIR_3000N_Parser.hpp>

class cHySpexVNIR_3000N_VerificationParser : public cHySpexVNIR_3000N_Parser
{
public:
