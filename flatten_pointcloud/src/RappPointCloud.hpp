...
{
public:
	typedef std::vector<rfm::rappPoint2_t>  vCloud_t;

	typedef std::vector<rfm::rappPoint2_t>::value_type				value_type;
	typedef std::vector<rfm::rappPoint2_t>::size_type				size_type;
	typedef std::vector<rfm::rappPoint2_t>::difference_type			difference_type;
	typedef std::vector<rfm::rappPoint2_t>::reference				reference;
	typedef std::vector<rfm::rappPoint2_t>::const_reference			const_reference;
	typedef std::vector<rfm::rappPoint2_t>::pointer					pointer;
	typedef std::vector<rfm::rappPoint2_t>::const_pointer			const_pointer;
	typedef std::vector<rfm::rappPoint2_t>::iterator				iterator;
	typedef std::vector<rfm::rappPoint2_t>::const_iterator			const_iterator;
	typedef std::vector<rfm::rappPoint2_t>::reverse_iterator		reverse_iterator;
	typedef std::vector<rfm::rappPoint2_t>::const_reverse_iterator  const_reverse_iterator;
...
public:
	...
	rfm::rappPoint2_t getPoint(int x_mm, int y_mm, int r_mm) const;
	...
	rfm::rappPoint2_t operator[](int i) const { return mCloud[i]; }
