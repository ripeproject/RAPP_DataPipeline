...
protected:
	void OnGroundMeshFile(wxCommandEvent& event);
...
private:
	wxTextCtrl* mpGroundMeshCtrl = nullptr;
	wxButton* mpGroundMeshFileButton = nullptr;
	...
	wxButton* mpFlattenButton = nullptr;
