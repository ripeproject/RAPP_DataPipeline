...
#include "ldBlockDataFileExceptions.hpp"
#include "ldCrc.hpp"
...
lidar_data::cBlockDataFileWriter::cBlockDataFileWriter()
{
    make_crc_table();
}

lidar_data::cBlockDataFileWriter::cBlockDataFileWriter(const std::string& filename)
...
bool lidar_data::cBlockDataFileWriter::open(const std::string& filename)
{
...
bool lidar_data::cBlockDataFileWriter::isOpen() const
{
    return mFile.is_open();
}

void lidar_data::cBlockDataFileWriter::close()
{
    mFile.close();
}

bool lidar_data::cBlockDataFileWriter::fail() const
{
    return mFile.fail();
}

bool lidar_data::cBlockDataFileWriter::bad() const
{
    return mFile.bad();
}

bool lidar_data::cBlockDataFileWriter::good() const
{
    return mFile.good();
}

bool lidar_data::cBlockDataFileWriter::writeBlock(const cBlockID& id)
{
...
bool lidar_data::cBlockDataFileWriter::writeBlock(const cBlockID& id, const std::byte* buf, std::size_t len)
{
    if (len == 0)
    {
...
lidar_data::cBlockDataFileReader::cBlockDataFileReader() : mByteSwapNeeded(false)
{
    make_crc_table();
}

lidar_data::cBlockDataFileReader::cBlockDataFileReader(const std::string& filename)
    : cBlockDataFileReader()
{
    open(filename);
}

lidar_data::cBlockDataFileReader::~cBlockDataFileReader()
{
    mFile.close();
}


bool lidar_data::cBlockDataFileReader::open(const std::string& filename)
{
...
bool lidar_data::cBlockDataFileReader::isOpen() const
{
    return mFile.is_open();
}

void lidar_data::cBlockDataFileReader::close()
{
    mFile.close();
}

bool lidar_data::cBlockDataFileReader::fail() const
{
    return mFile.fail();
}

bool lidar_data::cBlockDataFileReader::bad() const
{
    return mFile.bad();
}

bool lidar_data::cBlockDataFileReader::good() const
{
    return mFile.good();
}

bool lidar_data::cBlockDataFileReader::eof() const
{
    return mFile.eof();
}

std::streampos lidar_data::cBlockDataFileReader::filePosition()
{
    return mFile.tellg();
}

void lidar_data::cBlockDataFileReader::gotoPosition(std::streampos pos)
{
...
void lidar_data::cBlockDataFileReader::attach(cBlockParser* pParser)
{
    if (!pParser) return;
...
lidar_data::cBlockParser* lidar_data::cBlockDataFileReader::detach(cBlockID id)
{
...
bool lidar_data::cBlockDataFileReader::processBlock()
{
    if (mFile.eof())
        return false;
