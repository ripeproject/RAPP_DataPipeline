...
class cFileProcessor_Ceres : public cFileProcessor, public cExperimentParser, public cSpidercamParser
{
public:
	cFileProcessor_Ceres(int id, std::filesystem::directory_entry in,
				std::filesystem::path out);
	virtual ~cFileProcessor_Ceres();

	void setVnirRgb(float red_nm, float green_nm, float blue_nm) override;
	void setSwirRgb(float red_nm, float green_nm, float blue_nm) override;
