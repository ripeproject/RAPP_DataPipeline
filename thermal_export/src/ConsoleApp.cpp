...
int main(int argc, char** argv)
{
	...
	auto cli = lyra::cli()
		...
		("The path to input directory/file for converting themal imaging data to a multiband image file(s).")
		.required()
		| lyra::arg(output_directory, "output directory")
		("The path to output directory/file for the thermal data file(s).")
		.required();
