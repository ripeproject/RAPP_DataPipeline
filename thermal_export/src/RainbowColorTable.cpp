...
cRainbowColorTable::cRainbowColorTable() : cColorTable(RAINBOW_SIZE)
{}

cRainbowColorTable::cRainbowColorTable(double min, double max) : cColorTable(min, max, RAINBOW_SIZE)
{}
