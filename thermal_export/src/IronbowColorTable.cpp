...
cIronbowColorTable::cIronbowColorTable() : cColorTable(IRONBOW_SIZE)
{}

cIronbowColorTable::cIronbowColorTable(double min, double max) : cColorTable(min, max, IRONBOW_SIZE)
{}
