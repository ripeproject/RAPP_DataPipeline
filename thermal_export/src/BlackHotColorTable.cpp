...
cBlackHotColorTable::cBlackHotColorTable() : cColorTable(BLACK_HOT_SIZE)
{}

cBlackHotColorTable::cBlackHotColorTable(double min, double max) : cColorTable(min, max, BLACK_HOT_SIZE)
{}
