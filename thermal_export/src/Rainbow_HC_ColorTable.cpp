...
cRainbow_HC_ColorTable::cRainbow_HC_ColorTable() : cColorTable(RAINBOW_HC_SIZE)
{}

cRainbow_HC_ColorTable::cRainbow_HC_ColorTable(double min, double max) : cColorTable(min, max, RAINBOW_HC_SIZE)
{}
