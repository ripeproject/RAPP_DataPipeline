...
cWhiteHotColorTable::cWhiteHotColorTable() : cColorTable(WHITE_HOT_SIZE)
{}

cWhiteHotColorTable::cWhiteHotColorTable(double min, double max) : cColorTable(min, max, WHITE_HOT_SIZE)
{}
